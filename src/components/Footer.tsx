    ...
    <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 px-6 py-12">
      <div>
        ...
        <p className="leading-relaxed mb-4">
          India's largest Del Credere Agent for Reliance Textiles and a leading distributor for Reliance Polymers —
          building supply chains since 1972.
        </p>
        <div className="space-y-1.5">
          ...
          <a
            href="https://www.linkedin.com/company/devi-sahai-charan-dass-associates/"
            target="_blank"
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li>
            <Link to="/about" className="text-primary-foreground/65 hover:text-primary-foreground transition-colors">
              About Us
            </Link>
          </li>
          <li>
            <Link to="/products" className="text-primary-foreground/65 hover:text-primary-foreground transition-colors">
              All Products
            </Link>
          </li>
          <li>
            <Link to="/reliance" className="text-primary-foreground/65 hover:text-primary-foreground transition-colors">
              Reliance
            </Link>
          </li>
          <li>
            <Link to="/contact" className="text-primary-foreground/65 hover:text-primary-foreground transition-colors">
              Contact Us
            </Link>
          </li>
        </ul>
