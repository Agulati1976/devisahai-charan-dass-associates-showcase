...
const HeroSection = ({ onOpenRFQ }: HeroProps) => {
  ...
  return (
    <section className="relative overflow-hidden min-h-[560px] flex items-center py-16 px-6">
      {/* Background layers */}
      <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, hsl(224 55% 52%) 0%, hsl(224 50% 58%) 50%, hsl(224 45% 62%) 100%)" }} />
      <div className="absolute inset-0 opacity-[0.05]" style={{
        backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='1'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
      }} />
      <div className="absolute inset-0" style={{
        background: "radial-gradient(ellipse at 20% 50%, hsl(224 60% 65% / 0.3) 0%, transparent 55%), radial-gradient(ellipse at 80% 20%, hsl(43 87% 55% / 0.08) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, hsl(224 50% 55% / 0.3) 0%, transparent 50%)",
      }} />
      {/* Floating shapes */}
