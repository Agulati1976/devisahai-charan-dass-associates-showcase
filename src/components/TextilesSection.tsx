...
const textiles = [
  ...
  {
    title: "100% Polyester Suiting",
    subtitle: "Durable Wrinkle-Free Performance Fabric",
    ...
    specs: [
      ...
      { label: "Feature", value: "Wrinkle-Free" },
      { label: "Min. Order", value: "500 Mtr" },
    ],
  ...
  },
  {
    ...
    subtitle: "India's Premier Integrated Textile Manufacturer",
    description:
      "Complete range of wovens, knits, yarns, furnishing fabrics, and embroideries from one of India's premier integrated textile manufacturers.",
    image:
      "https://pplx-res.cloudinary.com/image/upload/pplx_search_images/3b1c27f5d6fc1547bd1b136438775952dc5fa45d.jpg",
    brand: "Alok Industries®",
    category: "Textiles",
    specs: [
      { label: "Range", value: "Wovens, Knits, Yarns" },
      { label: "Specialty", value: "Furnishing & Embroidery" },
      { label: "Min. Order", value: "500 Mtr" },
    ],
