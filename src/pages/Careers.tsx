...
const values = [
  { icon: Building2, title: "Company", { icon: Building2, title: "Company", desc: "55+ years of trusted partnership with Reliance Industries as Authorised Del Credere Agent" }, with Reliance Industries as Authorised Del Credere Agent" },
