              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@devisahaicharandass.com" className="text-sm text-primary hover:underline">info@devisahaicharandass.com</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-secondary flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Mon – Sat: 9:30 AM – 6:30 PM IST</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input type="tel" className={inputClass} placeholder="+91 98XXXXXXXX" required />
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea className={`${inputClass} min-h-[120px] resize-y`} placeholder="How can we help you?" required />
                  </div>
                  <button
                    type="submit"
