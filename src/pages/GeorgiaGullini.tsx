    ...
    <div>
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-brand-blue-dark">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-24">
          ...
          <p className="text-base max-w-2xl leading-relaxed mb-8 text-primary-foreground/75">Engineered for leaders who demand presence and performance — premium 100% polyester suiting fabric delivering a sharp, commanding silhouette with uncompromising durability.</p>
      ...
      <section className="max-w-[1200px] mx-auto py-16 px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-secondary rounded-xl p-8 text-center">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">Designed to hold its structure from boardroom to beyond — flawless finish, superior crease resistance, and long-lasting colour depth.</p>
            <p className="text-sm font-bold text-primary uppercase tracking-wider">Georgia Gullini defines strength, precision, and professional dominance.</p>
          </div>
        </div>
      </section>
