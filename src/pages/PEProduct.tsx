...
import {
  FileText, CheckCircle2, ChevronRight, Package, Award, Users, Cog,
...
const grades = [
  {
    ...
    desc: "Exceptional strength, durability, and chemical resistance across a wide range of densities.",
    apps: ["High-pressure pipes", "Telecom ducts", "Carrier bags", "Woven sacks", "Caps & closures", "Injection moulded products", "Blow moulded products"],
    note: "Designed for structural strength and long-term performance in demanding environments.",
  },
  {
    title: "Relene LLDPE",
    subtitle: "Linear Low-Density Polyethylene",
    desc: "Superior flexibility, impact strength, and excellent processability.",
    apps: ["Milk & edible oil packaging", "Extrusion coating", "Lamination films", "Cast films", "Stretch films", "Specialty films", "Rotational moulding", "Injection moulding"],
    note: "Ideal for applications requiring toughness and enhanced sealing properties.",
  },
  {
    title: "Relene LDPE",
    subtitle: "Low-Density Polyethylene",
    desc: "Excellent flexibility and clarity while maintaining durability across industrial uses.",
    apps: ["Heavy-duty films", "Lamination films", "Extrusion coating", "Moulding applications"],
    note: "A preferred choice for applications demanding resilience and smooth processing.",
  },
];
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-24">
          ...
          <button
            onClick={() => openRFQ("Polyethylene (PE)", "Relene® PE", "Polymers")}
      ...
      <section className="bg-brand-gray-50 py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <p className="text-muted-foreground leading-relaxed max-w-2xl mb-8">
            Serving industries such as packaging, infrastructure, agriculture, and construction, we remain a trusted distribution partner committed to delivering performance, consistency, and long-term value.
          </p>
      ...
      <section className="bg-primary py-16 px-6">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button onClick={() => openRFQ("Polyethylene (PE)", "Relene® PE", "Polymers")} className="inline-flex items-center gap-2 bg-destructive text-destructive-foreground font-bold px-7 py-3.5 rounded-lg hover:bg-brand-gold-dark transition-colors">
