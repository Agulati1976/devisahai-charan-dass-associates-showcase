      ...
      <section className="bg-primary py-16 px-6">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button onClick={() => openRFQ("Polyethylene (PE)", "Relene® PE", "Polymers")} className="inline-flex items-center gap-2 bg-destructive text-destructive-foreground font-bold px-7 py-3.5 rounded-lg hover:bg-brand-red-dark transition-colors">
