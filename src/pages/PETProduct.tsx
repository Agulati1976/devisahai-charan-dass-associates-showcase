...
import { Download, CheckCircle2, ChevronRight, Package, Award, Truck, Users, Cog, Shield, ArrowRight } from "lucide-react";
...
const features = ["High strength with excellent clarity", "Consistent intrinsic viscosity (IV) for reliable processing", "Excellent processability in ISBM", "Strong chemical and moisture resistance", "Food-contact compliant", "Lightweight and fully recyclable"];
const applications = ["Packaged drinking water bottles", "Carbonated soft drink (CSD) bottles", "Juice and dairy beverage bottles", "Sports and energy drink bottles", "Edible oil bottles", "Food-grade liquid packaging"];
const whyUs = [
    ...
    <div>
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-24">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-primary-foreground mb-4 text-balance">PET – Bottle Grade Solutions</h1>
          <p className="text-base max-w-2xl leading-relaxed mb-8" style={{ color: "hsl(0 0% 100% / 0.75)" }}>
            High-performance thermoplastic for rigid packaging — the preferred material for safe, lightweight, and sustainable bottle packaging.
          </p>
