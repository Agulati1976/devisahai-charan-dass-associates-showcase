...
import {
  FileText, CheckCircle2, ChevronRight, Award, Cog, Truck, ArrowRight
} from "lucide-react";
...
const applications = [
  ...
  "Wires, cables, and electrical conduits",
  "Medical products — blood bags, IV fluid bags, and tubing",
  "Toys, sports goods, and footwear",
];
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-24">
          ...
          <button
            onClick={() => openRFQ("PVC Resin", "Reon® PVC", "Polymers")}
      ...
      <section className="max-w-[1200px] mx-auto py-16 px-6">
        ...
        <p className="text-muted-foreground leading-relaxed max-w-3xl mb-8">
          PVC is extensively used in rigid and flexible applications across industries. Key applications include:
        </p>
      ...
      <section className="bg-brand-gray-50 py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <p className="text-muted-foreground leading-relaxed max-w-3xl mb-8">
            We provide reliable and performance-driven PVC materials supported by strong technical expertise, consistent quality assurance, and timely delivery. Serving sectors such as infrastructure, construction, electrical, medical, and consumer industries — we are supplying PVC to the leading names in the industry.
          </p>
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { icon: Award, label: "Strong Technical Expertise" },
              { icon: Cog, label: "Consistent Quality Assurance" },
      ...
      <section className="bg-primary py-16 px-6">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button onClick={() => openRFQ("PVC Resin", "Reon® PVC", "Polymers")} className="inline-flex items-center gap-2 bg-destructive text-destructive-foreground font-bold px-7 py-3.5 rounded-lg hover:bg-brand-gold-dark transition-colors">
