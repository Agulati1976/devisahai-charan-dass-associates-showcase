      ...
      <section className="bg-brand-gray-50 py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { src: "https://images.unsplash.com/photo-1558171813-4c088753af8f?w=600&auto=format", label: "Polyester Suiting Fabric" },
              { src: "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=600&auto=format", label: "Formal Suiting Collection" },
              { src: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=600&auto=format", label: "Corporate Wear Fabric" },
            ].map((img) => (
