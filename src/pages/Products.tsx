...
const allProducts: Product[] = [
  {
    ...
    description:
      "Homopolymer, random copolymer, and impact copolymer grades. Reliance is among the top 5 global manufacturers of polypropylene.",
    image: ppImg,
    category: "Polymers",
    brand: "Repol®",
    type: "PP",
    specs: [
      ...
      { label: "Applications", value: "Packaging, Auto, Furniture" },
  ...
  },
  {
    ...
    subtitle: "Relene® — HDPE, LLDPE & LDPE",
    description:
      "Complete range of HDPE, LLDPE, and LDPE grades. Secure applications ensuring maximum protection across packaging, agriculture, and industrial uses.",
    image: peImg,
    category: "Polymers",
    brand: "Relene®",
    type: "PE",
    specs: [
      { label: "Annual Capacity", value: "2.2 MMT" },
  ...
  },
  {
    ...
    description:
      "India's largest manufacturer of suspension-grade PVC. Wide viscosity range for agriculture, construction, and healthcare.",
    image: pvcImg,
    category: "Polymers",
    brand: "Reon®",
    type: "PVC",
  ...
  },
  {
    ...
    subtitle: "Relpet® — Bottle Grade PET Resin",
    description:
      "High strength with excellent clarity. Food-contact compliant, lightweight and fully recyclable. Ideal for ISBM applications.",
    image: petImg,
    category: "Polymers",
    brand: "Relpet®",
    type: "PET",
    specs: [
      { label: "Ideal for", value: "ISBM Applications" },
      { label: "Applications", value: "Beverages, FMCG, Pharma" },
      { label: "Min. Order", value: "1 MT" },
    ],
  ...
  },
  {
    ...
    description: "Curated gifting bundles — Poly-Viscose with premium finishes for institutional and bulk gifting.",
    image:
      "https://pplx-res.cloudinary.com/image/upload/pplx_search_images/77982e55d48a51c5729a6bd9c5e642bda6d0711b.jpg",
    category: "Textiles",
    brand: "Only Vimal®",
    type: "Gifting",
    specs: [
      { label: "Fabric", value: "Poly Viscose / Poly Cotton" },
      { label: "Width", value: '37" & 58"' },
  ...
  },
  {
    ...
    image:
      "https://pplx-res.cloudinary.com/image/upload/pplx_search_images/2dfe842e4023b65e62bab4d9afb27580e6086582.jpg",
    category: "Textiles",
    brand: "Georgia Gullini®",
    type: "Suiting",
    specs: [
      { label: "Fabric", value: "100% Wool / Wool-Blend" },
      { label: "Capacity", value: "10 Mn Mtr" },
  ...
  },
  {
    ...
    description:
      "Anti-Microbial, Anti-Dust, Quick Stain Release, and Fire-Proof options in Poly-Viscose, Poly-Cotton, and 100% Cotton.",
    image:
      "https://pplx-res.cloudinary.com/image/upload/pplx_search_images/3b1c27f5d6fc1547bd1b136438775952dc5fa45d.jpg",
    category: "Textiles",
    brand: "Only Vimal®",
    type: "Uniform",
    specs: [
      { label: "Capacity", value: "16 Mn Mtr" },
