...
import { CheckCircle2, ChevronRight, Gift, Star, Palette, Package, Users, Award, ArrowRight, Heart, Sparkles } from "lucide-react";
...
const solutions = ["Client & Partner Gifting", "Employee Rewards & Recognition", "Promotional & Branded Merchandise", "Festive & Occasion-Based Hampers", "Fully Customized Corporate Gifts"];
    ...
    <div>
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-brand-blue-dark">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-24">
          ...
          <p className="text-base max-w-2xl leading-relaxed mb-8 text-primary-foreground/75">Premium Vimal Gifting solutions through our subsidiary — designed to strengthen business relationships, enhance brand presence, and create lasting impressions.</p>
          <Link to="/contact" className="inline-flex items-center gap-2 bg-destructive text-destructive-foreground font-bold px-7 py-3.5 rounded-lg shadow-lg shadow-destructive/35 hover:bg-brand-gold-dark hover:-translate-y-0.5 transition-all">
      ...
      <section className="bg-brand-gray-50 py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[{ src: "https://pplx-res.cloudinary.com/image/upload/pplx_search_images/77982e55d48a51c5729a6bd9c5e642bda6d0711b.jpg", label: "Premium Suiting Gift Sets" }, { src: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&auto=format", label: "Corporate Fabric Bundles" }, { src: "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=600&auto=format", label: "Festive Gift Hampers" }].map((img) => (
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-card border border-brand-gray-200 rounded-xl p-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">With expert consultation, consistent quality, and timely delivery, Vimal Gifting ensures a seamless and impactful corporate gifting experience.</p>
              <p className="text-sm font-semibold text-primary">Elevate your gifting strategy with Vimal Gifting — where relationships are strengthened and brands are elevated.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-primary py-16 px-6">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to="/contact" className="inline-flex items-center gap-2 bg-destructive text-destructive-foreground font-bold px-7 py-3.5 rounded-lg hover:bg-brand-gold-dark transition-colors">
              Contact Us <ArrowRight className="w-4 h-4" />
            </Link>
