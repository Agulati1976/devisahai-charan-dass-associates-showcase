    ...
    <div>
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-brand-blue-dark">
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-24">
          ...
          <p className="text-base max-w-2xl leading-relaxed mb-8 text-primary-foreground/75">A distinguished selection of premium suiting fabrics that embody quality, craftsmanship, and timeless elegance.</p>
