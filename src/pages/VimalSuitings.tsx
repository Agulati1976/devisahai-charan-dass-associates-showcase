...
import {
  FileText, CheckCircle2, ChevronRight, Scissors, Gem, Palette,
  Shirt, ArrowRight, Award, Sparkles
} from "lucide-react";
...
const whyChoose = [
  { icon: Award, label: "Quality Craftsmanship", desc: "Suiting fabrics crafted with precision and care, ensuring exceptional quality and durability." },
  { icon: Palette, label: "Diverse Selection", desc: "Wide variety of colors, patterns, and textures to suit your unique style and preferences." },
  { icon: Scissors, label: "Custom Tailoring", desc: "Option of custom tailoring to create bespoke suits that fit perfectly and reflect individuality." },
  { icon: Gem, label: "Timeless Elegance", desc: "Classic, modern, and contemporary styles to meet various fashion sensibilities." },
];
    ...
    <div>
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-brand-blue-dark">
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-24">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-primary-foreground mb-4 text-balance">Only Vimal Suitings</h1>
          <p className="text-xl font-semibold text-primary-foreground/90 mb-2">Quality. Craftsmanship. Timeless Elegance.</p>
          <p className="text-base max-w-2xl leading-relaxed mb-8 text-primary-foreground/75">
            A distinguished selection of premium suiting fabrics that embody quality, craftsmanship, and timeless elegance.
          </p>
          <button onClick={() => openRFQ("Vimal Suitings", "Suiting Fabrics", "Textiles")} className="inline-flex items-center gap-2 bg-destructive text-destructive-foreground font-bold px-7 py-3.5 rounded-lg shadow-lg shadow-destructive/35 hover:bg-brand-gold-dark hover:-translate-y-0.5 transition-all">
      ...
      <section className="bg-brand-gray-50 py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {collections.map((c) => (
              <div key={c.title} className="bg-background border border-brand-gray-200 rounded-xl p-6 hover:border-primary hover:shadow-lg transition-all">
      ...
      <section className="bg-primary py-16 px-6">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <p className="text-sm mb-8 text-primary-foreground/70">Explore our extensive range and request a quote today.</p>
          <div className="flex gap-4 justify-center flex-wrap">
            <button onClick={() => openRFQ("Vimal Suitings", "Suiting Fabrics", "Textiles")} className="inline-flex items-center gap-2 bg-destructive text-destructive-foreground font-bold px-7 py-3.5 rounded-lg hover:bg-brand-gold-dark transition-colors">
